...
namespace Valve.VR.InteractionSystem
{
	...
	public class CircularDrive : MonoBehaviour
	{
		...
		[Tooltip( "If true, button hints when hovering over object will not show" )]
		...
		//-------------------------------------------------
		public void SetOutAngle(float value)
		{
			this.outAngle = value;
		}
