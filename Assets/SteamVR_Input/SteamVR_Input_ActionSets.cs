...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_customTest p_customTest;
        ...
        public static SteamVR_Input_ActionSet_customTest customTest
        {
            get
            {
                return SteamVR_Actions.p_customTest.GetCopy<SteamVR_Input_ActionSet_customTest>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_customTest = ((SteamVR_Input_ActionSet_customTest)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_customTest>("/actions/customTest")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.customTest};
        }
    }
}
